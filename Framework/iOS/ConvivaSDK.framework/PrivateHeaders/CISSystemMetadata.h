...
FOUNDATION_EXPORT NSString *const CIS_DEVICE_SCREEN_WIDTH;
FOUNDATION_EXPORT NSString *const CIS_DEVICE_SCREEN_HEIGHT;
FOUNDATION_EXPORT NSString *const CIS_DEVICE_SCREEN_SCALE_FACTOR;
