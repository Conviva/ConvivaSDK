...
FOUNDATION_EXPORT NSString *const PLATFORM_METADTA_KEY;
FOUNDATION_EXPORT NSString *const FRAMEWORK_NAME_KEY;
FOUNDATION_EXPORT NSString *const FRAMEWORK_VERSION_KEY;
