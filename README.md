...
2. Select version as:
    ...
    * 4.0.52 if it's without Advertising Identifier Support.
...
1.	Download the latest ConvivaSDK from below path.
      * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaSDK/archive/4.0.52.zip)
      OR
