...
## Cocoapods Installation
    ...
    pod 'ConvivaSDK','4.0.36'
    
## Swift Package Manager Installation
1. Add the Package Dependency repository URL as https://github.com/Conviva/conviva-ios-sdk-spm
2. Select version as:
    * 4.0.36 if it's with Advertising Identifier Support.
    * 4.0.37 if it's without Advertising Identifier Support.
...
1.	Download the latest ConvivaSDK from below path.
      * [Without Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaSDK/archive/4.0.37.zip)
      OR
     *  [With Advertising Identifier(IDFA) support](https://github.com/Conviva/ConvivaSDK/archive/4.0.36.zip)
